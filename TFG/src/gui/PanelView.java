		...
		groupLayout.createParallelGroup(Alignment.TRAILING)
			.addGroup(groupLayout.createSequentialGroup()
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup()
						.addComponent(analisiPersonalitzatLabel, GroupLayout.DEFAULT_SIZE, 586, Short.MAX_VALUE)
						.addContainerGap())
					.addGroup(groupLayout.createSequentialGroup()
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
							.addGroup(groupLayout.createSequentialGroup()
								...
								.addGap(59))
							.addGroup(groupLayout.createSequentialGroup()
								.addComponent(analisiCompletLabel, GroupLayout.DEFAULT_SIZE, 463, Short.MAX_VALUE)
								.addPreferredGap(ComponentPlacement.RELATED)))
						.addGap(133))))
			.addGroup(groupLayout.createSequentialGroup()
				.addGap(94)
				.addComponent(analisiCompletButton, GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
				.addGap(338))
			.addGroup(groupLayout.createSequentialGroup()
				.addGap(95)
				.addComponent(analisiPersonalitzatButton, GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
				.addGap(333))
			.addGroup(groupLayout.createSequentialGroup()
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup()
						.addGap(102)
						.addComponent(duracioButton, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
						.addGap(69))
					.addGroup(groupLayout.createSequentialGroup()
						.addContainerGap()
						.addComponent(lblOriolGassetRomo, GroupLayout.PREFERRED_SIZE, 178, Short.MAX_VALUE)
						.addPreferredGap(ComponentPlacement.RELATED)))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(btnCarregarAnlisi, GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
				.addGap(252))
	);
	groupLayout.setVerticalGroup(
		groupLayout.createParallelGroup(Alignment.LEADING)
			.addGroup(groupLayout.createSequentialGroup()
				.addComponent(analisiCompletLabel, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
				.addGap(1)
				.addComponent(analisiCompletButton, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(analisiPersonalitzatLabel, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
				.addPreferredGap(ComponentPlacement.RELATED)
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup()
						...
						.addComponent(lblOriolGassetRomo, GroupLayout.DEFAULT_SIZE, 18, Short.MAX_VALUE)
						.addContainerGap())
