...
public class PanelView extends JPanel {
	...
	groupLayout.setHorizontalGroup(
		groupLayout.createParallelGroup(Alignment.TRAILING)
			...
			.addGroup(groupLayout.createSequentialGroup()
				.addGap(94)
				.addComponent(analisiCompletButton, GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
				.addGap(338))
			.addGroup(groupLayout.createSequentialGroup()
				.addGap(95)
				.addComponent(analisiPersonalitzatButton, GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
				.addGap(333))
			.addGroup(groupLayout.createSequentialGroup()
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createSequentialGroup()
						.addContainerGap()
						.addComponent(lblOriolGassetRomo, GroupLayout.PREFERRED_SIZE, 128, Short.MAX_VALUE)
						.addGap(48)))
				.addComponent(btnCarregarAnlisi, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGap(272))
	);
			...
			.addGroup(groupLayout.createSequentialGroup()
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
					.addGroup(groupLayout.createSequentialGroup()
						...
						.addGap(18)
						.addComponent(lblOriolGassetRomo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
					.addGroup(groupLayout.createSequentialGroup()
